...
@external
func _set_admin{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(new_admin: felt) {
...
func upgrade{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    new_implementation: felt, selector: felt, calldata_len: felt, calldata: felt*
) {
    Proxy.assert_only_admin();
